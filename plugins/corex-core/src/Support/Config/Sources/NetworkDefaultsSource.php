 ...
 * FR-020–FR-024). It deliberately shares `corex_network_*` with network locks so changing scope
 * never requires data migration.
 */
final class NetworkDefaultsSource extends NetworkOptionSource
{
    protected function claimedScope(): SettingScope
    {
        return SettingScope::NetworkDefault;
    }
}
