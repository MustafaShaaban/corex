...
- [~] **T020** [US5] `WpNotificationPreferenceStore` + preferences UI (mandatory items non-disableable).
  ...
  - [ ] **Preferences UI** — a React panel/tab on the Notifications screen listing categories with toggles (mandatory shown disabled + explained), POSTing to the endpoint.
